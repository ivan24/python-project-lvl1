...
def brain_gcd():
    ...
    for i in range(0, 3):
        ...
        user_answer = get_user_answer(str(first_randon_value) + " " + str(second_random_value))
        correct_answer = get_common_division(first_randon_value, second_random_value)
...
def get_common_division(first_randon_value, second_random_value):
    ...
    return get_common_division(second_random_value % first_randon_value, first_randon_value)
